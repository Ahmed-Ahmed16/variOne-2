...
// USB wireless dongles (mice/keyboards). 2.4GHz HID dongles (e.g. Logitech
// Unifying) frequency-hop across the whole band, so 3 fixed channels left most
// dongles unaffected (issue 18). Sweep the full nRF 1-80 range like Bluetooth so
// every hop lands on a jammed channel.
